    ...
    <main style={pageStyles}>
      ...
      <div id="content">
        ...
        <div style={goalStyles}>
          ...
          <div>
          <p><strong>Improve application optimization skills -</strong> the purpose of this goal was to improve my ability to make software applications more efficient, in terms of the time and space complexity of crucial functionality. I was able to improve upon this skill through the Redis caching of API endpoints and database calls. I was also able to improve upon this skill through database queries. I learned more about SQL query optimization by utilizing b-trees to create database indexes to speed up popular queries by enabling them to run in logarithmic time instead of linear time. Finally, I was able to improve upon my optimization skills by refactoring code to remove unneeded and expensive requests when not being used by the user. These skills and more have helped me improve my overall software application optimization skills.</p>
          </div>
        </div>
